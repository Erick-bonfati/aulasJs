...
const sessionOptions = session({
    secret: 'assjnkddalkjhflakjshsdlkjahljkhvgoitroq2bv', //Este secret vai ser como um código secreto, que ninguem precisar saber para que serve
    ...
    cookie: { // Aqui vamos colocar a duração máxima que este cookie vai durar
        maxAge: 1000 * 60 * 60 * 24 * 7, // De milissegundos, até segundos, até minutos, horas, e por ultimo dias, TOTALIZANDO: 7 DIAS
